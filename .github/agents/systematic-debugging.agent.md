...
1. **Create Failing Test Case**
   ...
   - Use the `test-driven-development` agent for writing proper failing tests
...
These techniques are part of systematic debugging and available in the `systematic-debugging/` directory:
