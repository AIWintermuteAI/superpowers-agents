...
**Announce at start:** "I'm using the writing-plans agent to create the implementation plan."

**Context:** This should be run in a dedicated worktree (created by the `brainstorming` agent).

**Save plans to:**  workspace memory as YYYY-MM-DD-<feature-name>.md
...
- **REQUIRED:** Use the `subagent-driven-development` agent
- Fresh subagent per task + two-stage review

**If Inline Execution chosen:**
- **REQUIRED:** Use the `executing-plans` agent
